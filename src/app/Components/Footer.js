...
const Footer = () => {
  return (
    <div className="absolute left-1/2 -translate-x-1/2 -translate-y-32 border border-gray-200/80 py-3 px-2 flex gap-2 shadow-lg rounded-xl bg-white/80 hover:shadow-xl transition-all duration-300">
