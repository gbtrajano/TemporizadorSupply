...
const Footer = () => {
  return (
    <div
      className="absolute bottom-2 left-1/2 -translate-x-1/2 -translate-y-1/2 border border-gray-200/80 py-3 px-2 flex gap-2 shadow-lg rounded-xl bg-white/80 backdrop-blur-sm hover:shadow-xl transition-all duration-300"
    >
